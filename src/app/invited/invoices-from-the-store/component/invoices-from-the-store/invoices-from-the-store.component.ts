...
@Component({
    selector: 'app-invoices-from-the-store',
    templateUrl: './invoices-from-the-store.component.html',
    styleUrls: ['./invoices-from-the-store.component.css']
})
export class InvoicesFromTheStoreComponent implements OnInit {
    ...
    storage() {
        ...
        localStorage.setItem('role', 'InvoicesFromTheStore');
    }
