...
@Component({
    selector: 'app-invoice-store-businessman',
    templateUrl: './invoice-store-businessman.component.html',
    styleUrls: ['./invoice-store-businessman.component.css']
})
export class InvoiceStoreBusinessmanComponent implements OnInit {
    ...
    constructor(private _invoiceServices: InvoicesServices,
    ...
    storage() {
        ...
        localStorage.setItem('role', 'InvoicesFromTheStoreBusinessman');
    }
